...
class User {
  ...
  static async register({ username, password, first_name, last_name, phone }) {
    ...
    const result = await db.query(
      ...
      Values ($1, $2, $3, $4, $5, current_timestamp) Returning username, password, first_name, last_name, phone`, 
  ...
  static async messagesFrom(username) { 
    const results = await db.query(
      `Select m.id, m.to_username, m.body, m.sent_at, m.read_at, u.first_name, u.last_name, u.phone From messages As m
  ...
  static async messagesTo(username) { 
    const results = await db.query(
      `Select m.id, m.from_username, m.body, m.sent_at, m.read_at, u.first_name, u.last_name, u.phone From messages as m
